...
class HER(BaseRLModel):
    ...
    def __init__(self, policy, env, model_class, n_sampled_goal=4,
                 goal_selection_strategy='future', relative=False, her_clip_goals=False, 
                 goal_range_low=None, goal_range_high=None, 
                 *args, **kwargs):
    ...
    def _create_replay_wrapper(self, env):
        ...
        self.replay_wrapper = functools.partial(HindsightExperienceReplayWrapper,
                                                ...
                                                wrapped_env=self.env, relative=self.relative,
                                                goal_range_low=self.goal_range_low,
                                                goal_range_high=self.goal_range_high,
                                                her_clip_goals=self.her_clip_goals)
    ...
    def _save_to_file(self, save_path, data=None, params=None, cloudpickle=False):
        ...
        data['goal_range_low'] = self.goal_range_low
        data['goal_range_high'] = self.goal_range_high
        data['her_clip_goals'] = self.her_clip_goals
    ...
    def load(cls, load_path, env=None, custom_objects=None, **kwargs):
        ...
        model = cls(policy=data["policy"], env=env, model_class=data['model_class'],
                    ...
                    # goal_range_low=data['goal_range_low'],
                    # goal_range_high=data['goal_range_high'],
                    # her_clip_goals=data['her_clip_goals'],
